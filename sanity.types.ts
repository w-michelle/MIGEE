...
export type ACTIVE_PROMO_BANNER_RESULT = {
...
// Query: *[_type== "collection"] | order(title desc){      _id,      title,      "slug": slug.current    }
...
// Query: *[_type == "collection" && slug.current == $slug][0] {        title,        "slug": slug.current,        "products": products[]->{          ...,          optionSettings,          "optionSettingsResolved": optionSettings[]{            forOption,            "color": color->color          },          "variants": *[_type == "productVariant" && string(productID) == string(^.productID) ] {        ...,         }        }    }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_type == "product" && productTitle match $searchParam] | order(productTitle asc)': PRODUCT_SEARCH_QUERY_RESULT;
  }
}
